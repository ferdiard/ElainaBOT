...
Contoh : *${prefix}tiktokstalk @ferd2k21*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}igstalk @ferd2k21*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}smulestalk @ferd2k21*
...
Contoh : *${prefix}googlesearch siapa itu f4sbot*
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *F4S*
